...
@section('content')
 ...
 <label for="" style="margin-right:9px">Search Date:  </label>
    <input type="date"  name="from" class="form-control"  value="{{ $start_date }}" id="" placeholder="End Of Date" required>
  </div>
  
    <div class="form-group mx-sm-3 mb-2">
 <label for="" style="margin-right:9px">End Date:  </label>
    <input type="date"  name="to" class="form-control" value="{{ $end_date }}" id="" placeholder="End Of Date" required>
  </div>
...
<form class="form-inline" method="GET" action="{{ url('/admin/search_appo') }}">
  ...
  <div class="form-group mx-sm-3 mb-2">
  <label for="" style="margin-right:9px">Search Date:  </label>
    <input type="date"  name="search_date" class="form-control" value="" id="" placeholder="End Of Date" required>
  </div>
   @if($search_status=="pending")
     <input type="hidden" value="pending" name="search_status"> 
     @endif
  ...
  Sorry!! No Any Pending Appointment Found Between {{ $start_date }} to {{ $end_date }}
</div>
     @endif
     
       @if($search_status=="reply")
    <div class="alert alert-success" role="alert">
  Sorry!! No Any Reply Appointment Found Between {{ $start_date }} to {{ $end_date }}
</div>
     @endif
