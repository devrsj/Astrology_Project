            ...
            <div class="card card-primary">
              ...
              <form   method="post" action="{{ route('seo.update',$seo->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="webmaster" class="form-control" id="" placeholder="Web Master" value="{{ $seo->webmaster }}">
                  </div>

                <div class="form-group">
                    <label for="yandex">Yandex:</label>
                    <input type="text" name="yandex" class="form-control" id="" placeholder="Yandex" value="{{ $seo->yandex }}">
                  </div>

                <div class="form-group">
                    <label for="analaytic">Analaytic:</label>
                    <input type="text" name="analaytic" class="form-control" id="" placeholder="Analaytic" value="{{ $seo->analaytic }}">
                  </div>
               ...
               <div class="form-group">
                    ...
                    <input type="text" name="og_tag" class="form-control" id="" placeholder="Og Tag" value="{{ $seo->og_tag }}">
                  </div>
                ...
                <div class="form-group" id="image">
                  ...
                  <img src="{{ url('/') }}/storage/posts/{{  $seo->favicon  }}" height="50px" width="50px">
...
<div class="form-group">
 ...
 <textarea  name="meta_description" value="{{ old('meta_description') }}" rows="10" style="width:100%"> {{ $seo->meta_description }}</textarea>
