...
<div class="row">
    ...
    <button type="button" class="btn btn-default" style="" disabled>
               ...
               <a href="{{ route('blog.create') }}"><button type="button" class="btn btn-success" style="float:right">
           Add blogs</button></a>
...
{{ Str::limit($blog->heading, 20) }} 
                    ...
                    <td>@if($blog->image==null)
                       <p>no image</p>
                       @else
                       <img src="{{ url('/') }}/storage/posts/{{ $blog->image }}" height="50px" width="50px">
                       @endif </td>
