...
<select class="form-control" name="variant_product">
    <option value="all" class="form-control">all serivce products</option>
      ...
      <option value="latest-service-products" class="form-control">Latest service products</option>
      <option value="older-service-products" class="form-control">older service products</option>
