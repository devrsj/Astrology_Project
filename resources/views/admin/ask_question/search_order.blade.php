...
<form class="form-inline" method="GET" action="{{ url('/admin/order') }}">
  <div class="form-group mx-sm-3 mb-2">
   <label for="" style="margin-right:9px">Start Date:  </label>
    <input type="date" name="from" class="form-control" value="" id="" placeholder="Start Date" required>
  </div>
  <div class="form-group mx-sm-3 mb-2">
 <label for="" style="margin-right:9px">End Date:  </label>
    <input type="date"  name="to" class="form-control" id="" value="" placeholder="End Of Date" required>
  </div>
...
<form class="form-inline" method="GET" action="{{ url('/admin/search_order') }}">
 ...
 @if($search_status=="pending")
  ...
  Sorry!! No Any Pending AskQuestions Found In {{ $search_date }}
</div>
     @endif
     
       @if($search_status=="delivered")
    <div class="alert alert-success" role="alert">
  Sorry!! No Any Reply AskQuestions Found In {{ $search_date }}
</div>
     @endif
