            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @php
                    $i=1;
                    $orders=App\Models\Order::where('status','processing')->orderBy('id','asc')->get();
                  ...
                  <a href="{{ url('/admin/product/completed',$order->id) }} "><button type="button" class="btn btn-info btn-sm">
                    completed</button></a>
                    
                  <a href="{{ url('/admin/product/cancel',$order->id) }} "><button type="button" class="btn btn-info btn-sm">
                     Cancel </button></a>

                     <a href="{{ url('/admin/product/processing/view',$order->id) }} "><button type="button" class="btn btn-info btn-sm">
                     View </button></a>
