            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @php
                    $i=1;
                    $orders=App\Models\Order::where('status','decline')->orderBy('id','asc')->get();
                  ...
                  <td>
                     ...
                     <a href="{{ url('/admin/product/cancel/view',$order->id) }} "><button type="button" class="btn btn-info btn-sm">
                     View </button></a>
