...
<div class="form-group">
     ...
     <input type="number" name="mp" class="form-control"  placeholder="" value="{{ old('mp') }}" min="1">             
</div> 
...
<div class="form-group">
                    ...
                    <input type="number" name="sp" class="form-control"  placeholder="Enter the meta title" value="{{ old('sp') }}" min="1">
</div>
...
<div class="form-group">
                    ...
                    <input type="number" name="quantity" class="form-control"  placeholder="" value="{{ old('quantity') }}" min="1">
</div>
