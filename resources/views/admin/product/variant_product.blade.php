...
<select class="form-control" name="variant_product">
    <option value="all"@if($variant==="all") selected='selected' @endif class="form-control">all products</option>
      ...
      <option value="latest-products" @if($variant==="latest-products") selected='selected' @endif class="form-control">Latest  products</option>
      <option value="older-products" @if($variant==="older-products") selected='selected' @endif class="form-control">older  products</option>
